...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h4 mb-0">Edit About Section</h2>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('title_en') is-invalid @enderror" 
                                       id="title_en" name="title_en" value="{{ old('title_en', $section->title_en) }}" required>
                                @error('title_en')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('title_km') is-invalid @enderror" 
                                       id="title_km" name="title_km" value="{{ old('title_km', $section->title_km) }}" required>
                                @error('title_km')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    <option value="overview" {{ old('type', $section->type) == 'overview' ? 'selected' : '' }}>Overview</option>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control summernote @error('content_en') is-invalid @enderror" 
                                          id="content_en" name="content_en" rows="6" required>{{ old('content_en', $section->content_en) }}</textarea>
                                @error('content_en')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <textarea class="form-control summernote @error('content_km') is-invalid @enderror" 
                                          id="content_km" name="content_km" rows="6" required>{{ old('content_km', $section->content_km) }}</textarea>
                                @error('content_km')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                   id="sort_order" name="sort_order" value="{{ old('sort_order', $section->sort_order) }}" min="0">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ $section->is_active ? 'checked' : '' }}>
