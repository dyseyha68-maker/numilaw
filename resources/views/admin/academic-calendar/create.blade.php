...
@section('title', 'Create Academic Calendar Event')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Create Academic Calendar Event</h1>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control summernote @error('description_km') is-invalid @enderror" 
                                      id="description_km" name="description_km" rows="4">{{ old('description_km') }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('color_code') is-invalid @enderror" id="color_code" name="color_code" required>
                                @foreach($colorCodes as $code => $name)
                                    <option value="{{ $code }}" {{ old('color_code') == $code ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('recurring_pattern') is-invalid @enderror" 
                                    ...
                                    @foreach($recurringPatterns as $key => $label)
                                        <option value="{{ $key }}" {{ old('recurring_pattern') == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control summernote @error('notes_en') is-invalid @enderror" 
                                      id="notes_en" name="notes_en" rows="3">{{ old('notes_en') }}</textarea>
                            @error('notes_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <textarea class="form-control summernote @error('notes_km') is-invalid @enderror" 
                                      id="notes_km" name="notes_km" rows="3">{{ old('notes_km') }}</textarea>
                            @error('notes_km')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
