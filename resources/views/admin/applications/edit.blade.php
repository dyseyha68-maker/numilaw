...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">Edit Application</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="reviewing" {{ old('status', $application->status) == 'reviewing' ? 'selected' : '' }}>Reviewing</option>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="first_name_en" class="form-control" value="{{ old('first_name_en', $application->first_name_en) }}" required>
                    @error('first_name_en') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Last Name (English) *</label>
                    <input type="text" name="last_name_en" class="form-control" value="{{ old('last_name_en', $application->last_name_en) }}" required>
                    @error('last_name_en') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">First Name (Khmer)</label>
                    <input type="text" name="first_name_km" class="form-control" value="{{ old('first_name_km', $application->first_name_km) }}">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">Last Name (Khmer)</label>
                    <input type="text" name="last_name_km" class="form-control" value="{{ old('last_name_km', $application->last_name_km) }}">
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="date_of_birth" class="form-control" value="{{ old('date_of_birth', $application->date_of_birth) }}" required>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="high_school" class="form-control" value="{{ old('high_school', $application->high_school) }}" required>
                    @error('high_school') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label">Graduation Year *</label>
                    <input type="number" name="graduation_year" class="form-control" value="{{ old('graduation_year', $application->graduation_year) }}" min="1950" max="{{ date('Y') }}" required>
                    @error('graduation_year') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label">GPA (0-4.0) *</label>
                    <input type="number" name="gpa" class="form-control" value="{{ old('gpa', $application->gpa) }}" min="0" max="4" step="0.01" required>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <select name="english_level" class="form-select" required>
                        ...
                        <option value="beginner" {{ old('english_level', $application->english_level) == 'beginner' ? 'selected' : '' }}>Beginner</option>
                        <option value="intermediate" {{ old('english_level', $application->english_level) == 'intermediate' ? 'selected' : '' }}>Intermediate</option>
                        <option value="advanced" {{ old('english_level', $application->english_level) == 'advanced' ? 'selected' : 'selected' }}>Advanced</option>
                        <option value="fluent" {{ old('english_level', $application->english_level) == 'fluent' ? 'selected' : '' }}>Fluent</option>
                    </select>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="motivation_letter" class="form-control" rows="5" required>{{ old('motivation_letter', $application->motivation_letter) }}</textarea>
                    @error('motivation_letter') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label">Work Experience</label>
                    <textarea name="experience" class="form-control" rows="3">{{ old('experience', $application->experience) }}</textarea>
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label">Achievements or Awards</label>
                    <textarea name="achievements" class="form-control" rows="3">{{ old('achievements', $application->achievements) }}</textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="reference_name" class="form-control" value="{{ old('reference_name', $application->reference_name) }}" required>
                    @error('reference_name') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Reference Email *</label>
                    <input type="email" name="reference_email" class="form-control" value="{{ old('reference_email', $application->reference_email) }}" required>
                    @error('reference_email') <div class="text-danger">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Reference Phone *</label>
                    <input type="text" name="reference_phone" class="form-control" value="{{ old('reference_phone', $application->reference_phone) }}" required>
