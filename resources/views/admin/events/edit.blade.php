    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>Edit Event: {{ $event->title_en }}</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('title_km') is-invalid @enderror" 
                                   id="title_km" name="title_km" value="{{ old('title_km', $event->title_km) }}" required>
                            @error('title_km')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="project_id" name="project_id">
                                ...
                                @foreach($projects ?? [] as $project)
                                    <option value="{{ $project->id }}" {{ $event->project_id == $project->id ? 'selected' : '' }}>{{ $project->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control @error('start_datetime') is-invalid @enderror" 
                                   id="start_datetime" name="start_datetime" value="{{ old('start_datetime', $event->start_datetime ? $event->start_datetime->format('Y-m-d\TH:i') : '') }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control @error('end_datetime') is-invalid @enderror" 
                                   id="end_datetime" name="end_datetime" value="{{ old('end_datetime', $event->end_datetime ? $event->end_datetime->format('Y-m-d\TH:i') : '') }}" required>
                            @error('end_datetime')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control summernote @error('description_en') is-invalid @enderror" 
                                      id="description_en" name="description_en" rows="5" required>{{ old('description_en', $event->description_en) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control summernote @error('description_km') is-invalid @enderror" 
                                      id="description_km" name="description_km" rows="5" required>{{ old('description_km', $event->description_km) }}</textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @if($event->featured_image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $event->featured_image) }}" alt="Featured Image" style="max-width: 200px;">
                                </div>
                            @endif
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control @error('registration_deadline') is-invalid @enderror" 
                                   id="registration_deadline" name="registration_deadline" value="{{ old('registration_deadline', $event->registration_deadline ? $event->registration_deadline->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mt-4">
                                <input class="form-check-input" type="checkbox" id="is_registration_required" name="is_registration_required" value="1" {{ $event->is_registration_required ? 'checked' : '' }}>
