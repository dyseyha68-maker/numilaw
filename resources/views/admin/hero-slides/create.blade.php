...
@section('title', __('hero.add_slide'))

@section('content')
<div class="container-fluid">
    <form action="{{ route('admin.hero-slides.store') }}" method="POST" enctype="multipart/form-data" id="heroSlideForm">
    @csrf
    
    <input type="hidden" name="slide_key" value="{{ $pageKey }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="button_text_en" placeholder="e.g., Learn More">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">{{ __('hero.button_url') }}</label>
                                <input type="text" class="form-control" name="button_url" placeholder="/page-url">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="secondary_button_text_en" placeholder="e.g., Contact Us">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Secondary Button URL</label>
                                <input type="text" class="form-control" name="secondary_button_url" placeholder="/page-url">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg" name="title_km" required dir="ltr">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">{{ __('hero.subtitle') }} (KM)</label>
                        <input type="text" class="form-control" name="subtitle_km" dir="ltr">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">{{ __('hero.description') }} (KM)</label>
                        <textarea class="form-control" name="description_km" rows="4" dir="ltr"></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">{{ __('hero.button_text') }} (KM)</label>
                                <input type="text" class="form-control" name="button_text_km" dir="ltr">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Button Icon</label>
                                <input type="text" class="form-control" name="button_icon" placeholder="bi bi-arrow-right">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="image_alt_en">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Image Alt (KM)</label>
                        <input type="text" class="form-control" name="image_alt_km" dir="ltr">
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="use_theme" id="use_theme" checked>
                        <label class="form-check-label" for="use_theme">
                            {{ __('hero.use_theme') }}
                        </label>
                    </div>
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="show_content" id="show_content" checked>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="theme">
                            @foreach($themes as $key => $theme)
                                <option value="{{ $key }}" {{ $key === 'burgundy' ? 'selected' : '' }}>
                                    {{ $theme['name'] }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="show_animation" id="show_animation" checked>
            ...
            <div class="d-grid gap-2">
                ...
                <a href="{{ route('admin.hero-slides.index', ['page' => $pageKey]) }}" class="btn btn-secondary">
