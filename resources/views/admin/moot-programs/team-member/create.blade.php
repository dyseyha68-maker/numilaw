...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.moot-programs.team-members.store', [$moot->id, $participation->id, $team->id]) }}" 
              method="POST">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="role" name="role">
                        ...
                        <option value="{{ $value }}" {{ old('role', 'researcher') == $value ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                    <div class="form-check form-switch mt-4">
                        <input class="form-check-input" type="checkbox" id="is_team_lead" 
                               name="is_team_lead" value="1" {{ old('is_team_lead') ? 'checked' : '' }}>
