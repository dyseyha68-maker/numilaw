...
@section('title', $overview ? $overview->title : 'Overview')
...
<style>
    ...
    .overview-header .header-subtitle {
        font-family: var(--current-font);
        font-size: 1.1rem;
        color: #64748b;
        margin: 0;
        ...
        <div class="header-content">
            <nav aria-label="breadcrumb" style="position: relative; z-index: 10;">
                <ol class="breadcrumb mb-2">
                    ...
                    <li class="breadcrumb-item active" style="color: #003A46;">{{ __('about.overview') }}</li>
                </ol>
            </nav>
            <h1 class="header-title">
                {{ $overview ? $overview->title : __('about.overview') }}
            </h1>
            <p class="header-subtitle">
                Learn about our institution's rich history and commitment to legal excellence.
            </p>
        </div>
    </div>
</section>
...
<div class="container py-5" style="background: #f8fafb;">
    ...
    @else
        <div class="empty-state">
            ...
            <p class="text-muted mb-4">We're working on updating our overview information.</p>
            <a href="{{ route('public.about.index') }}" class="btn" style="background: linear-gradient(135deg, #003A46, #005f73); color: white;">
