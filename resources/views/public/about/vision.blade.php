...
@section('title', $vision ? $vision->title : 'Our Vision')
...
<style>
    ...
    .vision-header .header-content {
        position: relative;
        z-index: 2;
        margin-top: 30px;
    }

    .vision-header .header-title {
        ...
        <div class="header-content">
            <nav aria-label="breadcrumb" style="position: relative; z-index: 10;">
                <ol class="breadcrumb mb-2">
                    ...
                    <li class="breadcrumb-item active" style="color: #003A46;">{{ __('about.vision') }}</li>
                </ol>
            </nav>
            <h1 class="header-title">
                {{ $vision ? $vision->title : __('about.vision') }}
            </h1>
            <p class="header-subtitle">
                Explore our vision for the future of legal education and our commitment to developing tomorrow's legal leaders.
            </p>
        </div>
    </div>
</section>
...
<div class="container py-5" style="background: #f8fafb;">
            ...
            <div class="col-12">
                <div class="nav-card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('public.about.mission') }}" class="nav-btn btn text-decoration-none" style="background: #dcfce7; color: #16a34a;">
    ...
    @else
        <div class="empty-state">
            ...
            <p class="text-muted mb-4">We're working on updating our vision statement.</p>
            <a href="{{ route('public.about.index') }}" class="btn" style="background: linear-gradient(135deg, #ca8a04, #eab308); color: white;">
